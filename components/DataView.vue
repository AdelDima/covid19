<template>
  <v-card
    class="DataView bg-white w-full h-full p-4 rounded overflow-hidden shadow-lg"
  >
    <div class="DataView-Inner">
      ...
      <div class="DataView-CardText mt-5 mb-5">
        <slot />
      </div>
      <div
        class="DataView-Footer flex text-xs p-0 justify-between text-start text-gray-600"
      >
